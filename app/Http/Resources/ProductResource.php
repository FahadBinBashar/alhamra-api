...
class ProductResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'supplier_percentage' => $this->supplier_percentage !== null ? (int) $this->supplier_percentage : null,
            'supplier_down_payment_percentage' => $this->supplier_down_payment_percentage !== null ? (int) $this->supplier_down_payment_percentage : null,
