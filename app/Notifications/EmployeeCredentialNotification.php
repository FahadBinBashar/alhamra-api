...
class EmployeeCredentialNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage())
            ->subject('Your Al-Hamra account credentials')
            ->greeting('Hello ' . $notifiable->name . '!')
            ->line('An account has been created for you at Al-Hamra Brokerage Management System.')
