...
Route::prefix('v1')->group(function () {
  ...
  Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('promotions/awards/generate', [PromotionController::class, 'generateAwards']);
    Route::post('promotions/awards/process', [PromotionController::class, 'processAwards']);
    Route::get('employee/promotions/achievements', [PromotionController::class, 'employeeAchievements']);
    Route::get('employee/promotions/progress', [PromotionController::class, 'employeeProgress']);
    Route::get('employee/wallet/transactions', [PromotionController::class, 'employeeWalletTransactions']);
    ...
    Route::get('agent-settlements/my/pending', [AgentSettlementController::class, 'myPending']);
    Route::post('agent-settlements/my', [AgentSettlementController::class, 'store']);
    Route::get('agent-settlements/my', [AgentSettlementController::class, 'myRequests']);
    Route::get('admin/agent-settlements', [AgentSettlementController::class, 'index']);
    Route::post('admin/agent-settlements/{agentSettlement}/approve', [AgentSettlementController::class, 'approve']);
    Route::post('admin/agent-settlements/{agentSettlement}/reject', [AgentSettlementController::class, 'reject']);
